...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<!-- <div style=\"background-image: url('assets/thnx.jpg');\"> -->\n<img src=\"assets/thnx.jpg\" width=\"1540px\" height=\"700px\">");
...
/* harmony import */ var _registration_component_registration_component_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./registration-component/registration-component.component */ "./src/app/registration-component/registration-component.component.ts");
...
const routes = [
    { path: 'register', component: _registration_component_registration_component_component__WEBPACK_IMPORTED_MODULE_3__["RegistrationComponentComponent"] },
    { path: "", redirectTo: 'register', pathMatch: 'full' },
    { path: 'login', component: _login_component_login_component_component__WEBPACK_IMPORTED_MODULE_4__["LoginComponentComponent"] }
];
...
/* harmony import */ var _registration_component_registration_component_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./registration-component/registration-component.component */ "./src/app/registration-component/registration-component.component.ts");
...
/* harmony import */ var _mobile_mobile_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./mobile/mobile.component */ "./src/app/mobile/mobile.component.ts");
/* harmony import */ var _laptop_laptop_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./laptop/laptop.component */ "./src/app/laptop/laptop.component.ts");
/* harmony import */ var _led_led_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./led/led.component */ "./src/app/led/led.component.ts");
/* harmony import */ var _printers_printers_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./printers/printers.component */ "./src/app/printers/printers.component.ts");
/* harmony import */ var _cameras_cameras_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./cameras/cameras.component */ "./src/app/cameras/cameras.component.ts");
...
/* harmony import */ var _user_registration_service__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./user-registration.service */ "./src/app/user-registration.service.ts");
/* harmony import */ var _buy_buy_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./buy/buy.component */ "./src/app/buy/buy.component.ts");
/* harmony import */ var _desc_desc_component__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./desc/desc.component */ "./src/app/desc/desc.component.ts");
/* harmony import */ var _thnx_thnx_component__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./thnx/thnx.component */ "./src/app/thnx/thnx.component.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _registration_component_registration_component_component__WEBPACK_IMPORTED_MODULE_7__["RegistrationComponentComponent"],
            ...
            _mobile_mobile_component__WEBPACK_IMPORTED_MODULE_13__["MobileComponent"],
            _laptop_laptop_component__WEBPACK_IMPORTED_MODULE_14__["LaptopComponent"],
            _led_led_component__WEBPACK_IMPORTED_MODULE_15__["LedComponent"],
            _printers_printers_component__WEBPACK_IMPORTED_MODULE_16__["PrintersComponent"],
            _cameras_cameras_component__WEBPACK_IMPORTED_MODULE_17__["CamerasComponent"],
            _buy_buy_component__WEBPACK_IMPORTED_MODULE_20__["BuyComponent"],
            _desc_desc_component__WEBPACK_IMPORTED_MODULE_21__["DescComponent"],
            _thnx_thnx_component__WEBPACK_IMPORTED_MODULE_22__["ThnxComponent"]
            // MyMaterialMod/ule
        ],
        imports: [
            ...
            _angular_router__WEBPACK_IMPORTED_MODULE_9__["RouterModule"].forRoot([
                ...
                { path: 'register', component: _registration_component_registration_component_component__WEBPACK_IMPORTED_MODULE_7__["RegistrationComponentComponent"] },
                { path: 'login', component: _login_component_login_component_component__WEBPACK_IMPORTED_MODULE_8__["LoginComponentComponent"] },
                { path: 'sell', component: _sell_sell_component__WEBPACK_IMPORTED_MODULE_12__["SellComponent"] },
                { path: 'mobile', component: _mobile_mobile_component__WEBPACK_IMPORTED_MODULE_13__["MobileComponent"] },
                { path: 'laptop', component: _laptop_laptop_component__WEBPACK_IMPORTED_MODULE_14__["LaptopComponent"] },
                { path: 'led', component: _led_led_component__WEBPACK_IMPORTED_MODULE_15__["LedComponent"] },
                { path: 'printers', component: _printers_printers_component__WEBPACK_IMPORTED_MODULE_16__["PrintersComponent"] },
                { path: 'cameras', component: _cameras_cameras_component__WEBPACK_IMPORTED_MODULE_17__["CamerasComponent"] },
                { path: 'buy', component: _buy_buy_component__WEBPACK_IMPORTED_MODULE_20__["BuyComponent"] },
                { path: 'desc', component: _desc_desc_component__WEBPACK_IMPORTED_MODULE_21__["DescComponent"] },
                { path: 'thnx', component: _thnx_thnx_component__WEBPACK_IMPORTED_MODULE_22__["ThnxComponent"] },
            ]),
        ],
...
let BuyComponent = class BuyComponent {
    ...
    desc(Img, title, price, desc, brand) {
        this.UserSer.sendDesc(Img, title, desc, price, brand);
    }
    ngOnInit() {
        this.UserSer.msg$.subscribe(msgg => (console.log("msg recieved" + msgg),
            this.Fname = msgg));
        this.UserSer.getAllMobiles().subscribe(data => {
            this.Mobilearray = data;
            console.log(this.Mobilearray);
        });
        this.UserSer.getAllLaptop().subscribe(data => {
            this.Laptoparray = data;
            console.log(this.Laptoparray);
        });
        this.UserSer.getAllLed().subscribe(data => {
            this.Ledarray = data;
            console.log(this.Ledarray);
        });
        this.UserSer.getAllPrinter().subscribe(data => {
            this.Printerarray = data;
            console.log(this.Printerarray);
        });
        this.UserSer.getAllCamera().subscribe(data => {
            this.Cameraarray = data;
...
let CamerasComponent = class CamerasComponent {
    ...
    sm(Forms, brand, title, price, desc) {
        this.userReg.imgurl(this.selected).subscribe(data => {
            const img = data.data.link;
            this.ImgLink = img.toString();
            console.log(img);
            this.Brand = brand;
            this.Title = title;
            this.Price = price;
            this.Desc = desc;
            this.imglink = this.ImgLink;
            let response = this.userReg.addCamera(this.Brand, this.Title, this.Price, this.Desc, this.imglink);
            response.subscribe();
        }, error => { });
    }
};
CamerasComponent.ctorParameters = () => [
    { type: _user_registration_service__WEBPACK_IMPORTED_MODULE_2__["UserRegistrationService"] }
];
CamerasComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-cameras',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./cameras.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/cameras/cameras.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./cameras.component.css */ "./src/app/cameras/cameras.component.css")).default]
    })
], CamerasComponent);
...
let LaptopComponent = class LaptopComponent {
    ...
    sm(Forms, brand, title, price, desc) {
        this.userReg.imgurl(this.selected).subscribe(data => {
            ...
            this.Desc = desc;
            this.imglink = this.ImgLink;
            let response = this.userReg.addLaptop(this.Brand, this.Title, this.Price, this.Desc, this.imglink);
            response.subscribe();
        }, error => { });
    }
};
...
LaptopComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-laptop',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./laptop.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/laptop/laptop.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./laptop.component.css */ "./src/app/laptop/laptop.component.css")).default]
    })
], LaptopComponent);
...
let LedComponent = class LedComponent {
    constructor(userReg) {
        this.userReg = userReg;
        this.Price = "";
        this.Title = "";
    ...
    sm(title, price, desc) {
        this.userReg.imgurl(this.selected).subscribe(data => {
            ...
            this.Desc = desc;
            this.imglink = this.ImgLink;
            let response = this.userReg.addLED(this.Title, this.Price, this.Desc, this.imglink);
            response.subscribe();
        }, error => { });
    }
};
...
LedComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-led',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./led.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/led/led.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./led.component.css */ "./src/app/led/led.component.css")).default]
    })
], LedComponent);
...
let LoginComponentComponent = class LoginComponentComponent {
    ...
    login(email, password) {
        ...
        let response = this.UserSer.checklogin(this.Email, this.Password);
...
let MobileComponent = class MobileComponent {
    ...
    // sm(Forms:NgForm,brand:string,title:string,price:string,desc:string,ImgLink:string)
    // {
    //   this.Brand=brand;
    //   this.Title=title;
    //   this.Price=price;
...
let PrintersComponent = class PrintersComponent {
    constructor(userReg) {
        this.userReg = userReg;
        this.Price = "";
        this.Title = "";
    ...
    sm(title, price, desc) {
        this.userReg.imgurl(this.selected).subscribe(data => {
            ...
            this.Desc = desc;
            this.imglink = this.ImgLink;
            let response = this.userReg.addPrinter(this.Title, this.Price, this.Desc, this.imglink);
            response.subscribe();
        }, error => { });
    }
};
PrintersComponent.ctorParameters = () => [
    { type: _user_registration_service__WEBPACK_IMPORTED_MODULE_2__["UserRegistrationService"] }
];
PrintersComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-printers',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./printers.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/printers/printers.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./printers.component.css */ "./src/app/printers/printers.component.css")).default]
    })
], PrintersComponent);
...
let RegistrationComponentComponent = class RegistrationComponentComponent {
    ...
    OnSubmit(form) {
        // this.sm(form.value.fname,form.value.lname,form.value.bdate,form.value.email,form.value.password,form.value.address,form.value.gender,form.value.Pno);
    }
    sm(form, fname, lname, bdate, email, password, address, gender, Pno) {
        ...
        this.Phone = this.Pno;
        let response = this.userReg.doRegistration(this.Fname, this.Lname, this.Bday, this.Email, this.Pass, this.Gender, this.Address, this.Phone);
        response.subscribe(data => {
            console.log(data);
        });
    }
...
RegistrationComponentComponent.ctorParameters = () => [
    { type: _user_registration_service__WEBPACK_IMPORTED_MODULE_2__["UserRegistrationService"] }
];
RegistrationComponentComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-registration-component',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./registration-component.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/registration-component/registration-component.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./registration-component.component.css */ "./src/app/registration-component/registration-component.component.css")).default]
    })
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ThnxComponent", function() { return ThnxComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");


let ThnxComponent = class ThnxComponent {
    constructor() { }
    ngOnInit() {
    }
};
ThnxComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-thnx',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./thnx.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/thnx/thnx.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./thnx.component.css */ "./src/app/thnx/thnx.component.css")).default]
    })
], ThnxComponent);
...
let UserRegistrationService = class UserRegistrationService {
    ...
    sendDesc(Img, title, price, desc, brand) {
        this.Img1 = Img;
        this.Tt = title;
        this.Pr = price;
        this.De = desc;
    ...
    checklogin(Email, Password) {
        ...
        return this.http.post("http://localhost:8081/login", body, { headers: myheader });
    }
    doRegistration(fname1, lname1, bdate1, email1, password1, gender1, address1, Pno1) {
        const myheader = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set('Content-Type', 'application/x-www-form-urlencoded');
        let body = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]();
        ...
        return this.http.post("http://localhost:8081/register", body, { headers: myheader });
    }
    addMobile(brand1, title1, price1, desc1, imglink1) {
        const myheader = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set('Content-Type', 'application/x-www-form-urlencoded');
        let body = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]();
        ...
        return this.http.post("http://localhost:8081/mobile", body, { headers: myheader });
    }
    addLaptop(brand1, title1, price1, desc1, imglink1) {
        const myheader = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set('Content-Type', 'application/x-www-form-urlencoded');
        let body = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]();
        body = body.set('brand', brand1);
        body = body.set('title', title1);
        ...
        body = body.set('desc', desc1);
        body = body.set('imglink', imglink1);
        return this.http.post("http://localhost:8081/laptop", body, { headers: myheader });
    }
    addLED(title1, price1, desc1, imglink1) {
        const myheader = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set('Content-Type', 'application/x-www-form-urlencoded');
        let body = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]();
        body = body.set('title', title1);
        body = body.set('price', price1);
        body = body.set('desc', desc1);
        body = body.set('imglink', imglink1);
        return this.http.post("http://localhost:8081/led", body, { headers: myheader });
    }
    addPrinter(title1, price1, desc1, imglink1) {
        const myheader = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set('Content-Type', 'application/x-www-form-urlencoded');
        let body = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]();
        body = body.set('title', title1);
        body = body.set('price', price1);
        body = body.set('desc', desc1);
        body = body.set('imglink', imglink1);
        return this.http.post("http://localhost:8081/printer", body, { headers: myheader });
    }
    addCamera(brand1, title1, price1, desc1, imglink1) {
        const myheader = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set('Content-Type', 'application/x-www-form-urlencoded');
        let body = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]();
        body = body.set('brand', brand1);
        body = body.set('title', title1);
        ...
        body = body.set('desc', desc1);
        body = body.set('imglink', imglink1);
        return this.http.post("http://localhost:8081/camera", body, { headers: myheader });
    }
    sendFname(Fname) {
        this.msgsrc.next(Fname);
    }
    imgurl(file) {
        const headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ Authorization: "Client-ID 113e55b64dce4d1" });
        return this.http.post(this.imguploadurl, file, { headers });
    }
    getAllMobiles() {
...
module.exports = __webpack_require__(/*! C:\Users\HP\MainProject\src\main.ts */"./src/main.ts");
